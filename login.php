  ...
  <body>
    <?php
      ...
      if(isset($_POST["submit"]))
      {
        ...
        $stuResult = $db -> query("SELECT * FROM Student WHERE stuName = '$uname' and stuPassword = '$upass' and activeStatus = 'Active'");
        ...
        if($result -> num_rows != 0){
          ...
          echo "<p class='warning-msg'>Username/password is wrong or user is deactived!!</p>";
        }
